...
if (fs.existsSync(pathPrd)) {
    execute(`node ${pathPrd}/add_gradle_dependency.js "com.shakebugs.android:shake:10.0.+"`);
    ...
    execute(`node ${pathUat}/add_gradle_dependency.js "com.shakebugs.android:shake-uat:10.0.+"`);
    ...
    execute(`node ${pathStg}/add_gradle_dependency.js "com.shakebugs.android:shake-staging:10.0.+"`);
