...
if (fs.existsSync(pathPrd)) {
    execute(`node ${pathPrd}/remove_gradle_dependency.js "com.shakebugs.android:shake:9.0.+"`);
    ...
    execute(`node ${pathUat}/remove_gradle_dependency.js "com.shakebugs.android:shake-uat:9.0.+"`);
    ...
    execute(`node ${pathStg}/remove_gradle_dependency.js "com.shakebugs.android:shake-staging:9.0.+"`);
